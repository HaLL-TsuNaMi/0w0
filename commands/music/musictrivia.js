...
module.exports = class MusicTriviaCommand extends Command {
  ...
  async run(message, { numberOfSongs }) {
    ...
    if (!voiceChannel)
      return message.say('Pwease join a voice channew and twy again UmU');
    if (message.guild.musicData.isPlaying === true)
      return message.channel.send('A quiz or a song is awweady wunning UwU');
    ...
    const infoEmbed = new MessageEmbed()
      .setColor('#ff7373')
      .setTitle('Stawting Music Quiz')
      .setDescription(
        `Get weady! Thewe awe ${numberOfSongs} songs, you have 30 seconds to guess either the singew/band ow the name of the song. Good wuck! ( ͡o ꒳ ͡o )
        You can end the twivia at any point by using the end-trivia command`
      );
          ...
          collector.on('end', function() {
            ...
            */
            ...
            const embed = new MessageEmbed()
              .setColor('#ff7373')
              .setTitle(`The song was UwU:  ${song}`)
              .setDescription(
